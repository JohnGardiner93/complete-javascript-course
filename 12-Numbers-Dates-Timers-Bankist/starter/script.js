...
const account1 = {
  ...
  movementsDates: [
    ...
    '2021-02-22T14:43:26.374Z',
    '2021-02-24T18:49:59.371Z',
...
// Experimenting with the Intk API
...
console.log(4115451653163516351535135115351n);
console.log(BigInt(4115451653163516351535135115351n));

// Operations
console.log(10000n + 10000n);

console.log(65446818168165168168n * 5454798498498987n);

const huge = 513513516651651651651651n;
const num = 23;
...
// working with Dates
const future = new Date(2037, 10, 19, 15, 2300);
console.log(future);
...
// --- Mini Challenge---
// Make a clock... only show the hours, minutes, seconds via the setInterval function
